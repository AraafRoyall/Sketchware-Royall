...
*/	
	...
	public static int getIcon(String name) {
		return switch (name) {
			...
			// getIcon(String name)
			case "Add Source Directly" -> R.drawable.addsourcedirectlyevent;
			default -> {
				for (int i = 0, cachedCustomEventsSize = cachedCustomEvents.size(); i < cachedCustomEventsSize; i++) {
					HashMap<String, Object> customEvent = cachedCustomEvents.get(i);
					if (customEvent != null) {
	...
	public static String getDesc(String name) {
		return switch (name) {
			...
			// getDesc(String name)
			case "Add Source Directly" -> "Direct Inject java to Activity";
			default -> {
				for (int i = 0, cachedCustomEventsSize = cachedCustomEvents.size(); i < cachedCustomEventsSize; i++) {
					HashMap<String, Object> customEvent = cachedCustomEvents.get(i);
					if (customEvent != null) {
	...
	public static String getEventCode(String targetId, String name, String param) {
		return switch (name) {
			...
			param + "\r\n" +
			"}";
			// getEventCode(String targetId, String name, String param)
			case "Add Source Directly" -> param;
			default -> {
				for (int i = 0, cachedCustomEventsSize = cachedCustomEvents.size(); i < cachedCustomEventsSize; i++) {
					HashMap<String, Object> customEvent = cachedCustomEvents.get(i);
					if (customEvent != null) {
	...
	public static String getBlocks(String name) {
		return switch (name) {
			...
			// getBlocks(String name)
			case "Add Source Directly" -> "";
			default -> {
				for (int i = 0, cachedCustomEventsSize = cachedCustomEvents.size(); i < cachedCustomEventsSize; i++) {
					HashMap<String, Object> customEvent = cachedCustomEvents.get(i);
					if (customEvent != null) {
	...
	public static String getSpec(String name, String event) {
		return switch (event) {
			...
			// getSpec(String name, String event)
			case "Add Source Directly" -> "Add Source Directly";
			default -> {
				for (int i = 0, cachedCustomEventsSize = cachedCustomEvents.size(); i < cachedCustomEventsSize; i++) {
					HashMap<String, Object> customEvent = cachedCustomEvents.get(i);
					if (customEvent != null) {
